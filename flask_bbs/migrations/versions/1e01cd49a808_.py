...
Revision ID: 1e01cd49a808
Revises: fbec30b3bd16
Create Date: 2018-09-18 15:01:20.676000
...
revision = '1e01cd49a808'
down_revision = 'fbec30b3bd16'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('permissons', sa.Integer(), nullable=True),
